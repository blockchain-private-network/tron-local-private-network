...
setTimeout(async function() { 
        ...
        var unsignedVoteP1Txn = await tronWeb.transactionBuilder.voteProposal(1, true, tronWeb.defaultAddress.hex)
        var signedVoteP1Txn = await tronWeb.trx.sign(unsignedVoteP1Txn, "f4df789d3210ac881cb900464dd30409453044d2777060a0c391cbdf4c6a4f57");
        var rtn2 = await tronWeb.trx.sendRawTransaction(signedVoteP1Txn);
